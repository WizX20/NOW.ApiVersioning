...
using ApiTestApplication.Extensions;

namespace NOW.ApiTestApplication.Extensions.ServiceCollection
{
    public static class CorsPolicyExtensions
    {
        ...
        public static void AddCorsPolicy(this IServiceCollection services, string policyName, AppSettingsConfiguration appSettings)
        {
            ...
            var allowedOrigins = appSettings.ApiTestApplication?.CorsPolicy?.AllowedOrigins;
